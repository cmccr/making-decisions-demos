...
if (temperature > 80 && rain) {
  console.log('Grab a t-shirt and an umbrella.')
} else if (temperature > 60 && rain) {
  console.log('Grab a hoodie and umbrella.') 
} else if (temperature < 60 && rain) {
    console.log('Grab a coat and an umbrella.')
} else if (temperature > 80 && !rain) {
    console.log('A tank top should be fine')
} else if (temperature > 60 && !rain) {
  console.log('You may want a windbreaker today.')
} else {
  console.log('It will be a little cooler today.')
}
